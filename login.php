...
// se mudasse ali pra 'enviar' no inpurt o name deve ser enviar...
	...
	if($user == "" || $pass == "") { // aqui verifica se alguma das entradas esta vazia, caso esteja, cria o link para redirecionar para o login. Recarrega a pagina somente. 
		...
		echo "<script>window.location.href='login.php';</script>"; // location.href faz a redirecao automatica para a pagina definida. mas qual a diferença entre essa e a de cima?
		// a de cima vai ter que clicar para recarregar a pagina depois do erro, e nessa recarrega sozinha 
