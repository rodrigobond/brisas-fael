...
<?php session_start(); ?>
	...
	?>
	    ...
	    $id = $res['id']; } ?>
		<div class="header">
		<br><h1><strong><center>  :::::    Bem vindo ao Sistema  Estoque Brisas  :::::  </center></strong></h1></br>
	    </div>
		<h3 id="welcome_banner">Boa Tarde, <?php echo $_SESSION['name'] ?>!</h3><br><br><br>
        <div class="menu-index">
           <form>
            <br><input type=button onClick="parent.location='view.php'" value='Gerenciamento dos Produtos'><br>
			<br><input type=button onClick="parent.location='cart.php?id=<?php echo $id ?>'" value='Carrinho de Compras'><br>
		    <br><input type=button onClick="parent.location='logout.php'" value='Encerrar Sessão'><br><br><br>
